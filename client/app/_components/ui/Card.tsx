                ...
                <div className={shared ? "flex items-center justify-start h-[24px]" : "flex items-center justify-between h-[24px]"}>
                    ...
                    {!shared && (
                        <div className='w-[80px] justify-end items-center gap-4 flex relative'>
                            ...
                            {
                                selectActive && <div onClick={handleToggleIncludeInSelected} className={`rounded-full ${selected?"bg-black text-white":""} hover:bg-gray-600 hover:text-white hover:duration-200 hover:scale-90 cursor-pointer`}>
                                    <SelectIcon size='lg' />
                                </div>
                            }
                        </div>
